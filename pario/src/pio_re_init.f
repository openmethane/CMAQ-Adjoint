...
C $Header: /home/shunliu/src/cmaq/4.7.1/models/PARIO/src/pio_re_init.f,v 1.1.1.1 2009-12-10 15:44:47 sjr Exp $
...
C     LOGICAL WFLG               ! If .true. print out decompostion map
...
C ARGUMENTS:
      ...
      CHARACTER( 2 ), INTENT( IN ) :: COLROW  ! Columns/Rows orientation check
      ...
      LOGICAL, INTENT( IN ) :: WFLG     ! If .true. print out decomposition map
...
C LOCAL VARIABLES: 
      ...
      CHARACTER( 16 ), SAVE :: PNAME = 'PIO_RE_INIT'
