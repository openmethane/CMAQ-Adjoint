...
C $Header: /home/shunliu/src/cmaq/4.7.1/models/PARIO/src/ptrwrite3.f,v 1.1.1.1 2009-12-10 15:44:47 sjr Exp $ 
...
C External Functions:
      ...
      LOGICAL, EXTERNAL :: ENVYN    ! get YES/NO environment variable
...
C Get file description.
         IF ( .NOT. DESC3( FNAME ) ) THEN
             MSG = 'Could not get '// FNAME( 1:TRIMLEN( FNAME ) )
     &           // ' file description'
