...
C $Header: /home/shunliu/src/cmaq/4.7.1/models/PARIO/src/pm3exit.f,v 1.1.1.1 2009-12-10 15:44:47 sjr Exp $
...
C.......  Do M3EXIT tasks.
      ...
      IF ( EXITSTAT .NE. 0 ) THEN     ! Print messages for abnormal abort. 
          ...
          WRITE( LOGDEV,91010 ) PCALLER, MSGTXT( 1:TRIMLEN( MSGTXT ) )
     ...
     &                'Date&time specified as 0', ' ', ' '
      ...
      ELSE        ! Print message for normal completion.
            ...
            WRITE( LOGDEV,92010 ) PCALLER, MSGTXT( 1:TRIMLEN( MSGTXT ) )
...
c         CALL MPI_ABORT( MPI_COMM_WORLD, ERRCODE, IERROR )
