...
C $Header: /home/shunliu/src/cmaq/4.7.1/models/PARIO/src/gtndxhdv.f,v 1.1.1.1 2009-12-10 15:44:47 sjr Exp $
...
C INCLUDE FILES:
      ...
      INCLUDE 'IODECL3.EXT'         ! IOAPI definitions and declarations

C EXTERNAL FUNCTIONS:

      INTEGER, EXTERNAL :: INDEX1   ! Name-table lookup
      INTEGER, EXTERNAL :: TRIMLEN  ! Effective char. string length
...
C Concatenate file and variable names to make a unique string
      ...
      FVNAME = FILE( 1:TRIMLEN( FILE ) ) // '.' // VAR( 1:TRIMLEN( VAR ) )
