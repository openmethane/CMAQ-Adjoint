...
CONTAINS ! Routines in the module KPP_Integrator


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE INTEGRATE_ADJ( NADJ, YU, LambdaU, RKI, CHEMSTEP, &
...
!     (used only for full continuous adjoint)   
   REAL(kind=dp)  :: ATOL_adj(NVAR,NADJ), RTOL_adj(NVAR,NADJ)
!~~~> Optional input parameters and statistics
   ...
   REAL(kind=dp) :: YU(NVAR), LambdaU(NVAR), RKI(KNREACT), CHEMSTEP
...
!   rcntrl(3)=1.0d0
   ...
   CALL Shuffle_user2kpp ( LambdaU, Lambda )
   ...
   CALL Shuffle_kpp2user ( Lambda, LambdaU )
...
!~~~>    Compute LU decomposition 
   IF (.NOT.SaveLU) THEN
     CALL JacTemplate(RKI,Ystage(1),Ghimj)
     ISTATUS(Njac) = ISTATUS(Njac) + 1
...
!~~~>   Compute Hessian at the beginning of the interval
   CALL HessTemplate(RKI,Ystage(1),Hes0)
...
Stage: DO istage = ros_S, 1, -1
      ...
      !~~~> Compute V 
       Tau = T + ros_Alpha(istage)*Direction*H
       CALL JacTemplate(RKI,Ystage(istart),Jac)
       ISTATUS(Njac) = ISTATUS(Njac) + 1
       DO m = 1,NADJ
#ifdef FULL_ALGEBRA
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
SUBROUTINE HessTemplate( RKI, Y, Hes )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
